...
export const ExperienceSectionPrototype: React.FC = () => {
  const { t } = useLanguage();
  ...
  return (
    <section id="experience" className="w-full bg-[#060d24] py-16 px-5 md:px-10 lg:px-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col gap-10">
        ...
        {/* High-tech Connected Timeline with Staggered Pushed Cards */}
