...
export const GallerySectionPrototype: React.FC<GallerySectionProps> = ({ onSelectPhoto }) => {
  ...
  return (
    <section id="gallery" className="w-full bg-[#060d24] py-16 px-5 md:px-10 lg:px-20 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        ...
        {/* EXACT 8-PICTURE GRID with Staggered Push & Scale (0.94 → 1.0) */}
            ...
            return (
              <ScrollCard key={item.id} index={index} delay={0.1 + (index % 4) * 0.1}>
                <div
                  ...
                  className={`relative group aspect-[3/4] rounded-2xl overflow-hidden bg-surface-container shadow-md transition-all duration-500 cursor-pointer border border-primary/10 ${
                    isCyanHover
